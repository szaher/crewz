...
- [ ] T066 Implement chat message streaming via Socket.IO in `backend/src/services/chat_stream.py`
...
- [ ] T088 Implement GET/POST /api/v1/llm-providers in `backend/src/api/v1/llm_providers.py`
- [ ] T089 Implement GET/PUT/DELETE /api/v1/llm-providers/{provider_id} in `backend/src/api/v1/llm_providers.py`
...
### Frontend Core Setup
- [ ] T090 Create API client utility in `frontend/src/lib/api-client.ts` (fetch wrapper with JWT, tenant context)
- [ ] T091 Create WebSocket client in `frontend/src/lib/websocket.ts` (Socket.IO connection for chat)
- [ ] T092 Create SSE client in `frontend/src/lib/sse-client.ts` (EventSource for execution streams)
- [ ] T093 Create Zustand store in `frontend/src/lib/store.ts` (user, tenant, flows, agents, crews)
- [ ] T094 [P] Define TypeScript types from OpenAPI in `frontend/src/types/api.ts`

### Authentication UI
- [ ] T095 [P] Create LoginForm component in `frontend/src/components/auth/LoginForm.tsx`
- [ ] T096 [P] Create RegisterForm component in `frontend/src/components/auth/RegisterForm.tsx`
- [ ] T097 Create login page in `frontend/src/pages/auth/login.tsx`
- [ ] T098 Create register page in `frontend/src/pages/auth/register.tsx`

### Flow Editor Components
- [ ] T099 Create FlowCanvas component in `frontend/src/components/flows/FlowCanvas.tsx` (React Flow integration)
- [ ] T100 Create NodePalette component in `frontend/src/components/flows/NodePalette.tsx` (drag-drop node types)
- [ ] T101 Create PropertyPanel component in `frontend/src/components/flows/PropertyPanel.tsx` (node config sidebar)
- [ ] T102 [P] Create custom AgentNode in `frontend/src/components/flows/nodes/AgentNode.tsx`
- [ ] T103 [P] Create custom ToolNode in `frontend/src/components/flows/nodes/ToolNode.tsx`
- [ ] T104 [P] Create custom LLMNode in `frontend/src/components/flows/nodes/LLMNode.tsx`
- [ ] T105 [P] Create custom ConditionNode in `frontend/src/components/flows/nodes/ConditionNode.tsx`
- [ ] T106 Create flow editor page in `frontend/src/pages/flows/[flow_id]/edit.tsx`

### Crew Builder Components
- [ ] T107 Create CrewBuilder component in `frontend/src/components/crews/CrewBuilder.tsx`
- [ ] T108 [P] Create AgentCard component in `frontend/src/components/crews/AgentCard.tsx`
- [ ] T109 [P] Create AgentForm component in `frontend/src/components/crews/AgentForm.tsx`
- [ ] T110 Create crew management page in `frontend/src/pages/crews/index.tsx`

### Chat Interface Components
- [ ] T111 Create ChatWindow component in `frontend/src/components/chat/ChatWindow.tsx`
- [ ] T112 Create MessageList component in `frontend/src/components/chat/MessageList.tsx`
- [ ] T113 Create ExecutionTrace component in `frontend/src/components/chat/ExecutionTrace.tsx` (show tool calls)
- [ ] T114 Create chat page in `frontend/src/pages/chat/index.tsx`

### Tool Registry Components
- [ ] T115 [P] Create ToolRegistry component in `frontend/src/components/tools/ToolRegistry.tsx`
- [ ] T116 [P] Create ToolForm component in `frontend/src/components/tools/ToolForm.tsx` (with JSON Schema editor)
- [ ] T117 Create tools page in `frontend/src/pages/tools/index.tsx`

### Execution Monitoring Components
- [ ] T118 Create ExecutionList component in `frontend/src/components/executions/ExecutionList.tsx`
- [ ] T119 Create ExecutionDetail component in `frontend/src/components/executions/ExecutionDetail.tsx`
- [ ] T120 Create ExecutionLogs component in `frontend/src/components/executions/ExecutionLogs.tsx` (SSE stream)
- [ ] T121 Create executions page in `frontend/src/pages/executions/[execution_id].tsx`

### Dashboard & Navigation
- [ ] T122 Create Dashboard component in `frontend/src/components/dashboard/Dashboard.tsx` (metrics, recent activity)
- [ ] T123 Create Navigation component in `frontend/src/components/shared/Navigation.tsx`
- [ ] T124 Create dashboard page in `frontend/src/pages/dashboard/index.tsx`

### Shared Components
- [ ] T125 [P] Create Button component in `frontend/src/components/shared/Button.tsx`
- [ ] T126 [P] Create Modal component in `frontend/src/components/shared/Modal.tsx`
- [ ] T127 [P] Create LoadingSpinner component in `frontend/src/components/shared/LoadingSpinner.tsx`
- [ ] T128 [P] Create ErrorBoundary component in `frontend/src/components/shared/ErrorBoundary.tsx`
- [ ] T129 [P] Create Toast notification system in `frontend/src/components/shared/Toast.tsx`

### Frontend Layout
- [ ] T130 Create main layout in `frontend/src/pages/_app.tsx` (auth wrapper, navigation, theme)
